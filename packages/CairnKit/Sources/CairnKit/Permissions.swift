...
public enum PermissionSupport {
    public static let bundleDisplayName = "Cairn"
    public static let bundleIdentifier = "com.powerbeef.cairn"
    public static let developmentBundleDisplayName = "Cairn (Dev)"
    public static let developmentBundleIdentifier = "com.powerbeef.cairn.dev"
    ...
    public static func isCairnBundleIdentifier(_ bundleIdentifier: String?) -> Bool {
