...
public enum FixtureBridge {
    public static let appName = "CairnFixture"
    public static let distributedNotificationName = Notification.Name("com.powerbeef.cairn.fixture.command")

    public static var stateFileURL: URL {
        URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("cairn-fixture", isDirectory: true)
    ...
    public static func readState() throws -> FixtureAppState? {
        ...
        throw lastError ?? CairnError.message("Failed to read fixture state")
    }
